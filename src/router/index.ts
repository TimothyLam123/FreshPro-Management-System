...
export const asyncRouterMap: AppRouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'supplier',
        component: () => import('@/views/Authorization/Supplier/Supplier.vue'),
        name: 'Supplier',
        meta: {
      ...
      {
        path: 'planning',
        component: () => import('@/views/Authorization/Planning/Planning.vue'),
        name: 'Planning',
        meta: {
      ...
      {
        path: 'testData',
        component: () => import('@/views/Authorization/testData.vue'),
        name: 'testData',
        meta: {
          title: t('router.testData')
        }
      }
    ]
  }
